...
import in.co.cfcs.ehrnmt.Adapter.TraningAdapter;
import in.co.cfcs.ehrnmt.Main.AddandEditTraningActivity;
import in.co.cfcs.ehrnmt.Model.TraningModel;
...
public class TrainingFragment extends Fragment {
    ...
    public RecyclerView traniningRecycler;
    public TraningAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        traniningRecycler.setAdapter(adapter);

        traniningRecycler.getRecycledViewPool().setMaxRecycledViews(0, 0);

        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent i = new Intent(getActivity(), AddandEditTraningActivity.class);
                startActivity(i);
